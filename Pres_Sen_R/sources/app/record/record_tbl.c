...
const RecordTBL_t RecordTBL[] =
{
  // 在线升级参数
  {
    .dataType      = REC_DT_AppUpdate,
    .dataItem      = REC_DI_NONE,
    .devType       = REC_DEV_FM24CL64,
    .devAddr       = 0x01,
    .dataStartAddr = REC_Addr_BootParam,
    .dataItemSize  = sizeof(BootParam_t),
    .dataTotalSize = REC_Size_BootParam,
    .devTotalSize  = FM24C64_MAX_ADDR
  },
  ...
  // 阀门参数
  {
    .dataType      = REC_DT_Valve,
    .dataItem      = REC_DI_Param,
    .devType       = REC_DEV_FM24CL64,
    .devAddr       = 0x01,
    .dataStartAddr = REC_Addr_Valve,
    .dataItemSize  = sizeof(Valve_Param_t),
    .dataTotalSize = REC_Size_Valve,
    .devTotalSize  = FM24C64_MAX_ADDR
  },
  ...
  {
    .dataType      = REC_DT_Valve,
    .dataItem      = REC_DI_RTime,
    .devType       = REC_DEV_FM24CL64,
    .devAddr       = 0x01,
    .dataStartAddr = REC_Addr_Valve + sizeof(Valve_Param_t),
    .dataItemSize  = sizeof(Valve_RTime_t),
    .dataTotalSize = REC_Size_Valve,
    .devTotalSize  = FM24C64_MAX_ADDR
  },
  ...
  {
    .dataType      = REC_DT_Valve,
    .dataItem      = REC_DI_Cycle,
    .devType       = REC_DEV_FM24CL64,
    .devAddr       = 0x01,
    .dataStartAddr = REC_Addr_Valve + sizeof(Valve_Param_t) + sizeof(Valve_RTime_t),
    .dataItemSize  = sizeof(Valve_Cycle_t),
    .dataTotalSize = REC_Size_Valve,
    .devTotalSize  = FM24C64_MAX_ADDR
  },
