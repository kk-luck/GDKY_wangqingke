 ...
 */
extern uint8_t led_set(uint8_t led, uint8_t mode);

/*
 * Blink the LED.
 */
extern void led_blink(uint8_t leds, uint8_t numBlinks, uint8_t onPct, uint16_t period);

/*
 * Put LEDs in sleep state - store current values
 */
extern void led_sleep(void);
